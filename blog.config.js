...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Nguxw', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个还在努力的程序猿💻', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.nguxw.life/', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个程序猿, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',
